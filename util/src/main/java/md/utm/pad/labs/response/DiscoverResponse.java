...
public class DiscoverResponse implements Comparable<DiscoverResponse> {
    ...
    public int compareTo(DiscoverResponse other) {
        int connectionsResult = -Integer.compare(numberOfConnections, other.numberOfConnections);
        return connectionsResult == 0 ? -Integer.compare(collectionSize, other.collectionSize) : connectionsResult;
    }
}
